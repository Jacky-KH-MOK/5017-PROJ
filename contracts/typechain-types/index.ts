...
export type { CexAmlAuditTrail } from "./contracts/StablecoinMonitor.sol/CexAmlAuditTrail";
export { CexAmlAuditTrail__factory } from "./factories/contracts/StablecoinMonitor.sol/CexAmlAuditTrail__factory";
